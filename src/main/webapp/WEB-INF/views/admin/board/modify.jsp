	...
	<div id="wrap">
			...
			<section id="content">
				<form role="form" method="post" autocomplete="off" enctype="multipart/form-data">
					...
					<label>분류</label>
					<select name="bPart" id="bPart" value="${board.bPart}">
					...
					<label>내용</label>
					<textarea id="summernote" name="bCon" class="editordata">${board.bCon}</textarea>
					...
					<script>
						$("#back_Btn").click(function() {
							location.href = "/admin/board/view?n=" + ${board.bno};
						});
					</script>
				</form>
		</section>
